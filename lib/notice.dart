...
class _NoticeState extends State<Notice> {
  ...
  Future getpostNIDs() async{
    await FirebaseFirestore.instance.collection('NoticePosts').orderBy("date-time", descending: true).get().then((snapshot) => snapshot.docs.forEach((document){
                      ...
                      return ListTile(
                        title: Container(
                          decoration: BoxDecoration(
                            color: Color.fromARGB(238, 229, 225, 221),
